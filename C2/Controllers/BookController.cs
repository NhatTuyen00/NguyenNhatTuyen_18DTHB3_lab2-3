...
namespace C2.Controllers
{
    public class BookController : Controller
    {
        ...
        {
            return "Helllo  Nguyen Thanh Tung - University: " + university;
        }
        ...
        public ActionResult EditBook(int id)
        {
            ...
            books.Add(new Book(3, "Professional ASP.NET MVCS ", " Author Name Book 3", "/Content/Images/book3cover.png"));
            Book book = new Book();
       ...
       public ActionResult Contact([Bind(Include = "Id, Title, Author, ImageCover")]Book book)
        {
            ...
            catch (RetryLimiExceededException)
            {
